...
| bicep-curl | partial range of motion | mistake | 0.272 | 3 | 0 | 3 🔴 | 0 | 0/6 | full elbow extension; full range of motion at the elbow joint; fully extend the elbows at the bottom; limited range of motion; complete arm extension at the bottom; elbow in full extension |
| bicep-curl | partial range of motion | finding | 0.370 | 1 | 0 | 1 🔴 | 0 | n/a |  |
    ...
    bicep-curl partial range of motion         mistake  BAD   Failing to keep the upper arm stationary during the curl.
    bicep-curl partial range of motion         mistake  BAD   Allowing the elbows to flare outward during the curl.
    bicep-curl partial range of motion         mistake  BAD   Allowing the elbows to drift away from the body during the curl.
    bicep-curl partial range of motion         finding  BAD   Performing the curl on an incline bench at an angle of 45-60 degrees increases the stretch on the biceps' long head at the bottom position.
...
| bicep-curl | elbow flare | mistake | 0.057 | 2 | 2 | 0 | 0 | 2/4 | elbows to drift forward or away from the waist; elbows to pull forward |
| bicep-curl | elbow flare | finding | 0.442 | 0 | 0 | 0 | 0 | n/a |  |
| bicep-curl | partial range of motion | mistake | 0.272 | 3 | 1 | 2 🔴 | 0 | 1/6 | full range of motion at the elbow joint; fully extend the elbows at the bottom; limited range of motion; complete arm extension at the bottom; elbow in full extension |
| bicep-curl | partial range of motion | finding | 0.370 | 1 | 0 | 1 🔴 | 0 | n/a |  |
    ...
    bicep-curl partial range of motion         mistake  BAD   Failing to keep the upper arm stationary during the curl.
    bicep-curl partial range of motion         mistake  BAD   Excessive swinging of the body (using momentum) during standing curls.
    bicep-curl partial range of motion         finding  BAD   Performing the curl on an incline bench at an angle of 45-60 degrees increases the stretch on the biceps' long head at the bottom position.

**single summary (kb_local_curated_v4)** — faults with ≥1 correct mistake chunk: **8/10** · context chunks: 41 = good 21 / bad **14** / neutral 6 · precision(good/kept) = 0.51
  bad chunks under: bicep-curl/partial range of motion, lunge/insufficient back knee flexion, lunge/shallow lunge, push-up/partial range of motion, squat/butt wink, squat/knee valgus, squat/partial squat

**session summary (kb_local_curated_v4)** — faults with ≥1 correct mistake chunk: **5/6** · context chunks: 24 = good 12 / bad **9** / neutral 3 · precision(good/kept) = 0.50
  bad chunks under: bicep-curl/partial range of motion, lunge/insufficient back knee flexion, squat/butt wink, squat/partial squat
